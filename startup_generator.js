...
var thisArrayRand = thisArray[Math.floor(Math.random() * thisArray.length)];
var thatArrayRand = thatArray[Math.floor(Math.random() * thatArray.length)];

console.log( thisArrayRand + ' for ' + thatArrayRand);
...
for (var i = 1; i <= 5; i++) {
  var thisCombo = thisArray[Math.floor(Math.random() * thisArray.length)];
  var thatCombo = thatArray[Math.floor(Math.random() * thatArray.length)];

  console.log(i +'. ' + thisArrayRand + ' ' + thatArrayRand);
}
